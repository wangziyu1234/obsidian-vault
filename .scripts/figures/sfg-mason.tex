...
\begin{tikzpicture}[
  ...
  gain/.style = {font=\small, inner sep=1.6pt, text=figink, fill=white},
  loop/.style = {font=\small, color=figacc, inner sep=1.6pt},
  note/.style = {font=\footnotesize, color=figsub, fill=white}
]
