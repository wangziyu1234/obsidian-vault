...
\begin{scope}[shift={(0.8,-10.4)}]
  ...
  \node[sum] (s1) at (1.95,0) {};
  \node[blk] (g1) at (3.55,0) {$G_1$};
  \draw[->] (-0.4,0) -- (1.76,0);
  \draw[->] (X1) -- (0.95,-0.85) -- (3.55,-0.85) -- (3.55,-0.31);
  \node[sig] at (0.80,0.38) {$X_1$};
  \draw[->] (s1.east) -- (g1.west);
  \node[sig] at (2.72,0.28) {$X_2$};
  \draw[->] (g1.east) -- (4.6,0);
  \node[lbl] at (1.66,0.30) {$+$};
  \node[lbl] at (1.95,-0.44) {$-$};
...
\begin{scope}[shift={(7.7,-10.4)}]
  ...
  \coordinate (X2) at (3.75,0);
  \node[sum] (s1) at (4.55,0) {};
  \node[comp] (c) at (5.7,-1.1) {$\dfrac{1}{G_1}$};
  \draw[->] (-0.4,0) -- (g1.west);
  \draw[->] (g1.east) -- (4.36,0);
  \draw[->] (s1.east) -- (5.5,0);
  \node[sig] at (0.78,0.28) {$X_1$};
  \node[sig] at (3.05,0.28) {$X_2$};
  \draw[br] (X2) -- (X2 |- 0,-1.1) -- (c.east);
  \draw[br] (c.west) -- (4.55,-1.1) -- (s1.south);
...
\begin{scope}[shift={(7.7,-13.8)}]
  \coordinate (X1) at (0.85,0);
  \node[blk] (g1) at (2.5,0) {$G_1$};
  \node[comp] (c) at (0.85,0.95) {$\dfrac{1}{G_1}$};
  \draw[->] (-0.4,0) -- (g1.west);
  \draw[->] (g1.east) -- (4.5,0);
  \draw[br] (X1) -- (c.west);
  \draw[br] (c.east) -- (3.75,0.95);
  \node[sig] at (1.45,0.28) {$X_1$};
  \fill (X1) circle (1.6pt);
\end{scope}
...
\begin{scope}[shift={(0.8,-17.2)}]
  ...
  \draw[->] (-0.4,0) -- (g1.west);
  \draw[->] (g1.east) -- (4.5,0);
  \draw[br] (X1) -- (0.9,0.95) -- (2.45,0.95);
  \draw[br] (2.45,0.95) -- (4.5,0.95);
  \fill (X1) circle (1.6pt);
  \node[sig] at (1.3,0.28) {$X_1$};
\end{scope}
...
\begin{scope}[shift={(7.7,-17.2)}]
  \node[blk] (g1) at (2.1,0) {$G_1$};
  \coordinate (X2) at (3.35,0);
  \node[comp] (c) at (4.6,0.95) {$G_1$};
  \draw[->] (-0.4,0) -- (g1.west);
  \draw[->] (g1.east) -- (5.9,0);
  \draw[br] (X2) -- (c.west);
  \draw[br] (c.east) -- (5.9,0.95);
  \fill (X2) circle (1.6pt);
  \node[sig] at (3.5,0.28) {$X_2$};
\end{scope}
